...
$addKeys = @{ w_speed=0.08; ff_use_line=1.0; w_merge=6.0; k_d=3.0; head_use_line=0.0; w_len=0.015;
  ...
  vown_w=0.0; vown_raise=1.0; pdg_gain=0.0; brk_lock_slip=2.0; brk_lock_mode=0.0; vtrim_dmax=0.75; vtrim_quar=20.0; pad_clamp=0.0; spin_thr=0.0; ff_thr=0.0; a_full=14.6; ff_itrim=0.25; gs_max=0.0 }
